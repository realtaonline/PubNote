...
<xsl:variable name="pn:xlateLookup" as="document-node()" xml:lang="fr">
  <xsl:document>
    <xlate lookup="Abstract" mixed="true">L'abrégé</xlate>
    ...
    <xlate lookup="AffiliationInfo" force-close="">Détails sur l'affiliation</xlate>
    ...
    <xlate lookup="CoiStatement" mixed="">Déclaration de conflit d'intérêts</xlate>
    ...
    <xlate lookup="AbstractText" markdown="+" mixed="">Texte du l'abrégé</xlate>
    <xlate lookup="ArticleTitle" markdown="|" mixed="">Intitulé de l'article</xlate>
    <xlate lookup="b"   mixed="" markdown="*">gras</xlate>
    <xlate lookup="i"   mixed="" markdown="/">italique</xlate>
    <xlate lookup="inf" mixed="" markdown="~" replace="sub">indice</xlate>
    <xlate lookup="sub" mixed="" markdown="~">indice</xlate>
    <xlate lookup="sup" mixed="" markdown="^">exposant</xlate>
    <xlate lookup="u"   mixed="" markdown="_">trait de soulignement</xlate>
  </xsl:document>
</xsl:variable>
